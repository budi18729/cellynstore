...
COGS = [
    ...
    "cogs.jualbeli", "cogs.testimoni", "cogs.giveaway", "cogs.welcome",
    ...
    "cogs.vilog", "cogs.store_status", "cogs.free_game_notifier", "cogs.mobile_game_notifier", "cogs.genshin_notifier", "cogs.top_spender"
]
